          ...
          <div className={`absolute inset-0 top-32 px-10 pb-10 flex flex-col transition-all duration-500 ${reserveStage === 'intro' ? 'opacity-100 z-10' : 'opacity-0 z-0 pointer-events-none'}`}>
             ...
             <div className="mt-8 w-full space-y-3">
                <button 
                    ...
                    className="w-full py-4 bg-stone-100 text-stone-900 border border-stone-200 text-sm font-bold rounded-xl hover:bg-stone-200 transition-all flex items-center justify-center gap-2 shadow-sm active:scale-[0.98]"
                >
                    이미 예매하셨나요?
                </button>
                <button 
